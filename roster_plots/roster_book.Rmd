...
if(group_name == "EB25 training") {
  ...
  logo <- "Super_League_-_logo.png"
} else if (group_name == "Super League S7") {
  logo <- "Super_League_-_logo.png"
}


# Get the races from the ruleset settings
races <- read_ods("bb_tournament_settings.ods", sheet="gold-SPP-per-roster") %>% 
